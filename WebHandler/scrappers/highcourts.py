...
def get_highcourt_cases_by_name(props):
    ...
    for case in cases:
        ...
        # case details
        case_details_title = "case_details_title"
        case_details_cnr_no = "case_details_cnr_no"
        case_details_filing_date = "case_details_filing_date"
        case_details_registration_no = "case_details_registration_no"
        case_details_registration_date = "case_details_registration_date"
